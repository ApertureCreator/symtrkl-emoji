...
**Contributions:**  
`aneobot_blink`, `aneobot_bongo`, `aneobot_floof_blink`, `aneobot_jump`, `aneobot_mlem`, `aneobot_talk`, `aneobot_toast`, `aneobot_walk`, `neobot_baby_gob`, `neobot_cartridge`, `neobot_kiss_bot`, `neobot_legs`, `neobot_nom_disc`, `neobot_smol`, `neobot_spoon_bot`, `neobot_spoon_bread`, `neobot_spoon_cat`, `neobot_spoon_fox`, `neobot_spoon_possum`, `neobot_spoon_potato`, `neobot_train_wagon`, `neobot_toaster_down`, `neobot_toaster_empty`, `neobot_toaster_heat`, `neobot_toaster_load`, `neobot_toaster_mid`, `neobot_toaster_up`, `neobot_turned_on`, `neocatraxx_spoon_neobot`, `neomouse_spoon_bot`, all `neobot_code` variants, and most SVG source files (goodness that's a lot) by James, *CC-BY-NC-SA 4.0*, <https://kitty.social/@o76923>  
...
`neobot_error` by Δ-44203, *CC-BY-NC-SA 4.0*, <https://mastodon.vierkantor.com/@1>
